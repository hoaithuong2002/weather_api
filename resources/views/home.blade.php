                    ...
                    <div class="card card-weather">
                        <div class="card-body">
                            <div class="weather-date-location">
                                <h3>Tuesday</h3>
                                <p class="text-gray"> <span class="weather-date">30 March, 2021</span> <span class="weather-location">phú thọ , VietNam</span> </p>
                            </div>
                            <div class="weather-data d-flex">
                                <div class="mr-auto">
                                    <h4 class="display-3">{{ $data['temperature'] }} <span class="symbol">°</span>C</h4>
